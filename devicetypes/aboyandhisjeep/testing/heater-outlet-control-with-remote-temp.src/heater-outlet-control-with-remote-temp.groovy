 ...
 *
 *
 * Build off Simulated Thermostat from SmartThings Device Handler
 */
 
metadata {
	// Automatically generated. Make future change here.
	definition (name: "Heater Outlet Control with Remote Temp", namespace: "ABoyAndHisJeep/testing", author: "Forrest Goodson") {
